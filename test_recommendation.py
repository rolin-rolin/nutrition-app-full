...
def test_recommendation_pipeline():
    ...
    # Set a dummy OpenAI API key for testing (you'll need a real one for full functionality)
    ...
    try:
        for i, test_case in enumerate(test_cases, 1):
            ...
            try:
                ...
                print(f"\n🍽️  Recommended Snacks ({len(result.recommended_products)} items):")
                total_protein = 0
                total_carbs = 0
                total_fat = 0
                total_calories = 0
...
if __name__ == "__main__":
    ...
    print("2. Set your OPENAI_API_KEY in the environment or .env file")
